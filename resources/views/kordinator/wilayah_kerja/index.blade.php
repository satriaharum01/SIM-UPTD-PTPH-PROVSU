                      ...
                      <div class="table-responsive">
                        <table class="table table-hover" id="data-width" width="100%">
                            <thead>
                              <tr>
                                <th width="10%"></th>
                                <th class="text-primary" width="20%">Nama Kecamatan</th>
                                <th class="text-primary" width="20%">Nama Daerah</th>
                                <th class="text-primary" width="15%">Jumlah Petugas</th>
...
<script>
  ...
  $("body").on("click", ".btn-add", function () {
    window.location.href = "{{route('kordinator.wilayah_kerja.new')}}";
  })

  $("body").on("click", ".btn-edit", function () {
    var Id = $(this).attr("data-id");
    var url = "{{ route('kordinator.wilayah_kerja.edit', ':id') }}".replace(':id', Id);
