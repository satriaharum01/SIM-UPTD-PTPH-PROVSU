                      ...
                      <div class="table-responsive">
                        <table class="table table-hover" id="data-width" width="100%">
                            <thead>
                              <tr>
                                <th width="10%"></th>
                                <th class="text-primary" width="15%">Kecamatan</th>
                                <th class="text-primary" width="15%">Wilayah Kerja</th>
                                <th class="text-primary">Tanaman</th>
                                <th class="text-primary" width="15%">Jenis OPT</th>
                                <th class="text-primary" width="15%">Tanggal</th>
