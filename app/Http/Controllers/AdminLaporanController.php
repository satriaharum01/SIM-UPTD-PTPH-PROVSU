...
class AdminLaporanController extends Controller
{
    ...
    public function filterData(Request $request)
    {
        ...
        $data = Laporan::whereHas('verifikasi', function ($query) {
            ...
            ->when($request->kabupaten_id, function ($query, $kabupaten) {
                $query->whereHas('cariWilayahKerja.cariKecamatan.cariKabupaten', function ($q) use ($kabupaten) {
                    $q->where('id', $kabupaten); // Sesuaikan dengan nama kolom yang menyimpan ID kabupaten
                });
            })
